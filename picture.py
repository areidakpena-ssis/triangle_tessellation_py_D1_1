...
def draw_picture(width, height):
    ...
    sg.set_fill_color(colors[2])  # set fill color to blue

    for i in range(5):
        sg.fill_triangle(2*TRIANGLE_WIDTH, i*TRIANGLE_HEIGHT, 
    ...
    # code for GREEN triangles
     sg.set_fill_color(colors[1]) # set fill color to green (BIBU)
    ...
    sg.set_fill_color(colors[3]) # set fill color to cyan
